...
ifeq ($(useshared),yes)
  ...
  INCLUDEOPT+=-I$(CURDIR)/src/external/zlib-1.2.8 \
              -I$(CURDIR)/src/external/lua_md5/src \
...
LIBLUA_SRC=src/lualib.c\
           src/external/lua_md5/src/md5.c\
           src/external/lua_md5/src/md5lib.c\
           src/external/lua_md5/src/des56.c\
           src/external/lua_md5/src/ldes56.c\
           src/external/lua_md5/src/compat-5.2.c\
